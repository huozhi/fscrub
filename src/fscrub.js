...
function fscrub(
  ...
  function handleStart(e) {
    ...
    if (isHoverEnabled && (isMouseTypePointerEvent(e) || isMouseEvent(e))) onStart(e)
  }
  ...
  function handleMove(e) {
    if (isMoving) {
      ...
      if (isHoverEnabled && (isMouseTypePointerEvent(e) || isMouseEvent(e))) onMove(e)
    }
  }
  ...
  function handleEnd(e) {
    ...
    if (isHoverEnabled && (isMouseTypePointerEvent(e) || isMouseEvent(e))) onEnd(e)
  }
